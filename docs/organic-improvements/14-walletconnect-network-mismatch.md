# WalletConnect network mismatch check
...
- Reconfirm mismatch error copy includes the expected target network name.

Follow-up note: Verify network mismatch copy still matches wallet provider wording.
